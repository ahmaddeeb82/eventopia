...
class PublicEventReservationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'public_info' => 'sometimes|array',
            'public_info.category' => 'required_with:public_info|array',
            'public_info.category.existed' => 'sometimes|array',
            'public_info.category.existed.id' => 'sometimes|integer|exists:categories,id',
            'public_info.category.added' => 'sometimes|array',
            'public_info.category.added.name' => 'sometimes|array|required_array_keys:ar,en',
            'public_info.info' => 'required_with:public_info|array|required_array_keys:description,name,address,ticket_price',
            'public_info.info.description' => 'required_with:public_info.info|max:100',
            'public_info.info.name' => 'required_with:public_info.info|string',
            'public_info.info.address' => 'required_with:public_info.info|string',
            'public_info.info.ticket_price' => 'required_with:public_info.info|numeric',
        ];
    }
